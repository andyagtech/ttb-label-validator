...
export const cls = {
  ...
  /** Nav / toolbar buttons */
  navButton: "flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg border border-gray-300 text-gray-600 hover:bg-gray-50 transition",

  /** Primary action button */
  buttonPrimary: "flex items-center justify-center gap-2 py-2.5 text-xs font-medium rounded-lg bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-40 disabled:cursor-not-allowed transition shadow-sm",
  ...
  /** Form input */
  input: "w-full px-2.5 py-1.5 text-xs border border-gray-200 rounded bg-white focus:border-blue-400 focus:ring-1 focus:ring-blue-200 outline-none",

  /** Status badge */
  badge: (color: string, bg: string) => `inline-flex items-center gap-1 px-2 py-0.5 text-[11px] font-medium rounded-full ${bg} ${color}`,
