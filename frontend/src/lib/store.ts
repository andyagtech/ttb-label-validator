...
const TTB_LABEL_IMAGES: Record<string, number[]> = {
  ...
  "25335001000029": [1, 2, 3],  // VOLADA
  "25335001000078": [1, 2],  // 450 NORTH BREWING CO.
  "25335001000085": [1, 2],  // AMERICAN SOLERA
  "25335001000169": [2],  // FREE WILL BREWING
  "25335001000197": [1, 2],  // CZECH 10°
  "25335001000267": [1, 2],  // LAMPLIGHTER BREWING CO.
  "25335001000295": [2, 3],  // POINT
  "25335001000316": [2],  // RAPID LIBERTIES HAZY DIPA
  "25335001000325": [1, 2],  // BOREAL DAWN BLACK IPA
  ...
  "25335001000463": [1, 2, 3],  // MONSIER GENUINE BLACK
  ...
  "25335001000875": [1, 2],  // FOUR HOUNDS DISTILLING
  "25335001000932": [1, 2],  // L'ECU
  "25335001000946": [1, 2],  // MADWOMAN
  "25335001000960": [3, 2],  // DAISY CREEK (3=front artwork, 2=info/back)
  "25335001000981": [1, 2, 3],  // NEW BELGIUM
  "25335001000995": [1, 2, 3],  // THE REVERIES
  "25336001000162": [1, 2],  // TENNESSEE SHINE CO
  ...
  "26003001000085": [2],  // BURDOCK BREWERY
