...
const SUBCATEGORY_MAP: SubcategoryEntry[] = [
  ...
  { term: "wine cooler", pattern: /\bwine\s+cooler\b/i, parent: "beer", subcategory: "Wine Cooler" },
  ...
  { term: "lambic", pattern: /\blambic\b/i, parent: "beer", subcategory: "Lambic" },
  { term: "gueuze", pattern: /\bgu?euze\b/i, parent: "beer", subcategory: "Gueuze" },
  // German / European styles
  ...
  { term: "schwarzbier", pattern: /\bschwarzbier\b/i, parent: "beer", subcategory: "Schwarzbier" },
  { term: "vienna lager", pattern: /\bvienna\s+lager\b/i, parent: "beer", subcategory: "Vienna Lager" },
  { term: "altbier", pattern: /\baltbier\b/i, parent: "beer", subcategory: "Altbier" },
  { term: "rauchbier", pattern: /\brauchbier\b/i, parent: "beer", subcategory: "Rauchbier" },
  // Sour styles
  ...
  { term: "imperial stout", pattern: /\bimperial\s+stout\b/i, parent: "beer", subcategory: "Imperial Stout" },
  { term: "milk stout", pattern: /\bmilk\s+stout\b/i, parent: "beer", subcategory: "Milk Stout" },
  { term: "oatmeal stout", pattern: /\boatmeal\s+stout\b/i, parent: "beer", subcategory: "Oatmeal Stout" },
  // Core styles
  ...
  { term: "red ale", pattern: /\b(?:irish\s+)?red\s+ale\b/i, parent: "beer", subcategory: "Red Ale" },
  { term: "golden ale", pattern: /\bgolden\s+ale\b/i, parent: "beer", subcategory: "Golden Ale" },
  ...
  { term: "old ale", pattern: /\bold\s+ale\b/i, parent: "beer", subcategory: "Old Ale" },
  { term: "mild ale", pattern: /\bmild\s+ale\b/i, parent: "beer", subcategory: "Mild Ale" },
  ...
  { term: "fruit beer", pattern: /\bfruit\s+(?:beer|ale)\b/i, parent: "beer", subcategory: "Fruit Beer" },
  ...
  { term: "ESB", pattern: /\bESB\b/, parent: "beer", subcategory: "Extra Special Bitter" },
  { term: "bitter", pattern: /\b(?:extra\s+special\s+)?bitter\b/i, parent: "beer", subcategory: "Bitter" },
  { term: "pilsner", pattern: /\bpils(?:ner)?\b/i, parent: "beer", subcategory: "Pilsner" },
  ...
  { term: "shandy", pattern: /\bshandy\b/i, parent: "beer", subcategory: "Shandy" },
  ...
  // ── Wine ────────────────────────────────────────────────────────────────
  // Wine types (compound before generic)
  ...
  { term: "ice wine", pattern: /\bice\s*wine\b/i, parent: "wine", subcategory: "Ice Wine" },
  { term: "natural wine", pattern: /\bnatural\s+wine\b/i, parent: "wine", subcategory: "Natural Wine" },
  ...
  { term: "cava", pattern: /\bcava\b/i, parent: "wine", subcategory: "Cava" },
  { term: "blanc de blancs", pattern: /\bblanc\s+de\s+blancs\b/i, parent: "wine", subcategory: "Blanc de Blancs" },
  { term: "blanc de noirs", pattern: /\bblanc\s+de\s+noirs\b/i, parent: "wine", subcategory: "Blanc de Noirs" },
  { term: "late harvest", pattern: /\blate\s+harvest\b/i, parent: "wine", subcategory: "Late Harvest" },
  ...
  { term: "pinot blanc", pattern: /\bpinot\s+blanc\b/i, parent: "wine", subcategory: "Pinot Blanc" },
  ...
  { term: "mourvèdre", pattern: /\bmourv[eè]dre\b/i, parent: "wine", subcategory: "Mourvèdre" },
  ...
  { term: "grüner veltliner", pattern: /\bgr[uü]ner\s+veltliner\b/i, parent: "wine", subcategory: "Grüner Veltliner" },
  { term: "albariño", pattern: /\balba(?:ri[nñ]o|rinho)\b/i, parent: "wine", subcategory: "Albariño" },
  { term: "torrontés", pattern: /\btorront[eé]s\b/i, parent: "wine", subcategory: "Torrontés" },
  { term: "gamay", pattern: /\bgamay\b/i, parent: "wine", subcategory: "Gamay" },
  { term: "nebbiolo", pattern: /\bnebbiolo\b/i, parent: "wine", subcategory: "Nebbiolo" },
  { term: "barbera", pattern: /\bbarbera\b/i, parent: "wine", subcategory: "Barbera" },
  { term: "dolcetto", pattern: /\bdolcetto\b/i, parent: "wine", subcategory: "Dolcetto" },
  { term: "montepulciano", pattern: /\bmontepulciano\b/i, parent: "wine", subcategory: "Montepulciano" },
  { term: "petite sirah", pattern: /\bpetite?\s+si?rah\b/i, parent: "wine", subcategory: "Petite Sirah" },
  { term: "petit verdot", pattern: /\bpetit\s+verdot\b/i, parent: "wine", subcategory: "Petit Verdot" },
  { term: "carménère", pattern: /\bcarm[eé]n[eè]re\b/i, parent: "wine", subcategory: "Carménère" },
  { term: "marsanne", pattern: /\bmarsanne\b/i, parent: "wine", subcategory: "Marsanne" },
  { term: "roussanne", pattern: /\broussanne\b/i, parent: "wine", subcategory: "Roussanne" },
  ...
  { term: "tennessee whiskey", pattern: /\btennessee\s+whisk(?:e?y)\b/i, parent: "spirits", subcategory: "Tennessee Whiskey" },
  ...
  { term: "irish cream", pattern: /\birish\s+cream\b/i, parent: "spirits", subcategory: "Irish Cream" },
  ...
  { term: "genever", pattern: /\bgenever\b/i, parent: "spirits", subcategory: "Genever" },
  ...
  { term: "armagnac", pattern: /\barmagnac\b/i, parent: "spirits", subcategory: "Armagnac" },
  { term: "calvados", pattern: /\bcalvados\b/i, parent: "spirits", subcategory: "Calvados" },
  ...
  { term: "baijiu", pattern: /\bbaijiu\b/i, parent: "spirits", subcategory: "Baijiu" },
  ...
  { term: "aperitif", pattern: /\baperitif\b/i, parent: "spirits", subcategory: "Aperitif" },
  { term: "digestif", pattern: /\bdigestif\b/i, parent: "spirits", subcategory: "Digestif" },
  ...
  { term: "schnapps", pattern: /\bschnapps\b/i, parent: "spirits", subcategory: "Schnapps" },
  { term: "moonshine", pattern: /\bmoonshine\b/i, parent: "spirits", subcategory: "Moonshine" },
