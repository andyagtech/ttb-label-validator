...
export function getChecklistTemplate(
  ...
  const ALL_ITEMS: Omit<ChecklistItem, "status">[] = [
    ...
    },
    {
      ...
      label: "Net contents",
      description:
        "Volume statement (e.g., 750 mL, 12 FL OZ). Must appear on front or back.",
    ...
    },
    {
      ...
      description:
        "Name and address of the bottler, packer, or importer. Must include city and state.",
      appliesTo: ["back"],
      categories: "all",
      autoDetectable: "server",
      mandatory: true,
    ...
    },
    {
      ...
      description:
        '"Contains Sulfites" — required if wine contains 10+ ppm of sulfur dioxide.',
