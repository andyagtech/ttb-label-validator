...
export function getChecklistTemplate(
  ...
  const ALL_ITEMS: Omit<ChecklistItem, "status">[] = [
    ...
    },
    {
      ...
      description: '"Contains Sulfites" — required on wine labels (virtually all wines contain ≥ 10 ppm SO₂) per 27 CFR §4.32(e).',
    ...
    },
    {
      id: "sulfite_declaration",
      label: "Sulfite declaration",
      description: '"Contains Sulfites" — required for malt beverages containing 10+ ppm sulfur dioxide per 27 CFR §7.63.',
      appliesTo: ["back", "front"],
      categories: ["beer"],
      autoDetectable: "server",
      mandatory: false,
    ...
    {
      id: "color_ingredients",
      label: "Color ingredient disclosures",
      description: 'If coloring materials (e.g., caramel color, FD&C dyes) are added, they must be disclosed on the label.',
      appliesTo: ["back", "front"],
      categories: "all",
      autoDetectable: "server",
      mandatory: false,
    ...
    {
      id: "commodity_statement",
      label: "Commodity statement",
      description: 'Required for distilled spirits in certain containers (e.g., "Distilled Spirits Specialty"). Per 27 CFR §5.63.',
      appliesTo: ["back", "front"],
      categories: ["spirits"],
      autoDetectable: "server",
      mandatory: false,
    ...
    {
      id: "aspartame_declaration",
      label: "Aspartame declaration",
      description: 'Required for malt beverages containing aspartame: "Phenylketonurics: Contains Phenylalanine" per 27 CFR §7.63.',
      appliesTo: ["back", "front"],
      categories: ["beer"],
      autoDetectable: "server",
      mandatory: false,
